...
var _crevax$electron_playground$Hello$view = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$html$Html$text('We are using node x, '),
			_elm_lang$html$Html$text('Chrome y, '),
			_elm_lang$html$Html$text('and Electron z.')
		]));
var _crevax$electron_playground$Hello$main = {main: _crevax$electron_playground$Hello$view};
